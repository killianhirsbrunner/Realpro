...
const navigation = [
  ...
  { name: 'Immeubles', href: '/properties', icon: Building },
  { name: 'Copropriétaires', href: '/owners', icon: Users },
  { name: 'Comptabilité', href: '/accounting', icon: Receipt },
  { name: 'Fonds', href: '/funds', icon: Wallet },
  { name: 'Documents', href: '/documents', icon: FileText },
  { name: 'Travaux', href: '/works', icon: Wrench },
  { name: 'Assemblées', href: '/meetings', icon: Calendar },
  { name: 'Paramètres', href: '/settings', icon: Settings },
];

export function PPEAdminLayout() {
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-neutral-200 dark:border-neutral-800">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="ml-1 text-xs text-emerald-600 font-medium">PPE Admin</span>
            </div>
          </div>
          <button
