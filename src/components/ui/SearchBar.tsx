    ...
    <div className="relative flex-1 max-w-2xl">
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-10 pl-10 pr-10 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
        />
        {query && (
          <button
            onClick={() => {
