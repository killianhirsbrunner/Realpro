      ...
      <div className="border-t border-neutral-200 p-4">
        <div className="flex items-end gap-2">
          <textarea
            ...
            className="flex-1 resize-none rounded-lg border border-neutral-300 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 min-h-[44px] max-h-[120px]"
            rows={1}
          />
          <button
            onClick={handleSend}
