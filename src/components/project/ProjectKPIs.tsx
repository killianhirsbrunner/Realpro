...
export function ProjectKPIs({ sales, notary, finance, construction }: ProjectKPIsProps) {
  return (
    <div className="space-y-6">
      {sales && (
        <section>
          <h2 className="text-xl font-semibold text-neutral-900 mb-4">Ventes & commercialisation</h2>
          ...
          <Card className="mt-4">
            <CardContent>
              <div className="flex items-center justify-between text-sm mb-2">
                <span className="font-medium text-neutral-700">Taux de commercialisation</span>
      ...
      {notary && (
        <section>
          <h2 className="text-xl font-semibold text-neutral-900 mb-4">Dossiers notaire</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card hover>
              <CardContent>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-neutral-500 mb-1">Dossiers prêts</p>
                    <p className="text-3xl font-bold text-neutral-900">{notary.ready_files}</p>
                  </div>
            ...
            <Card hover>
              <CardContent>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-neutral-500 mb-1">Dossiers signés</p>
                    <p className="text-3xl font-bold text-neutral-900">{notary.signed_files}</p>
                  </div>
            ...
            <Card hover>
              <CardContent>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-neutral-500 mb-1">Dossiers incomplets</p>
                    <p className="text-3xl font-bold text-neutral-900">{notary.incomplete_files}</p>
                  </div>
      ...
      {finance && (
        <section>
          <h2 className="text-xl font-semibold text-neutral-900 mb-4">Budget CFC</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card>
              <CardContent>
                <p className="text-xs text-neutral-500 mb-1">Budget initial</p>
                <p className="text-lg font-semibold text-neutral-900">{formatCHF(finance.cfc_budget)}</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent>
                <p className="text-xs text-neutral-500 mb-1">Engagé</p>
            ...
            <Card>
              <CardContent>
                <p className="text-xs text-neutral-500 mb-1">Facturé</p>
            ...
            <Card>
              <CardContent>
                <p className="text-xs text-neutral-500 mb-1">Payé</p>
      ...
      {construction && (
        <section>
          <h2 className="text-xl font-semibold text-neutral-900 mb-4">Avancement chantier</h2>
          <Card>
            <CardContent>
              <div className="flex items-center justify-between text-sm mb-2">
                <span className="font-medium text-neutral-700">Progression globale</span>
                <span className="text-neutral-900 font-semibold text-lg">
