    ...
    <div className="bg-white rounded-xl border border-neutral-200 p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-neutral-900">CRM & Ventes</h3>
            <p className="text-sm text-neutral-500">Pipeline commercial</p>
          </div>
        </div>
        <Link
        ...
        <div className="bg-neutral-50 rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-neutral-900">Prospects</span>
            </div>
            <span className="text-lg font-bold text-neutral-900">{data.prospects.total}</span>
          </div>
