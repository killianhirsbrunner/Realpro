...
import ProjectLotsSummaryCard from '../components/project/ProjectLotsSummaryCard';
import ProjectCRMSummaryCard from '../components/project/ProjectCRMSummaryCard';
import ProjectFinancesSummaryCard from '../components/project/ProjectFinancesSummaryCard';
import ProjectSubmissionsSummaryCard from '../components/project/ProjectSubmissionsSummaryCard';
import ProjectModificationsSummaryCard from '../components/project/ProjectModificationsSummaryCard';

export default function ProjectCockpitDashboardIntegrated() {
        ...
        <section>
          <div className="mb-6">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">
              Tous les modules métier connectés à ce projet
            </p>
          </div>
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            <ProjectLotsSummaryCard projectId={projectId} />
            <ProjectCRMSummaryCard projectId={projectId} />
            <ProjectFinancesSummaryCard projectId={projectId} />
            <ProjectSubmissionsSummaryCard projectId={projectId} />
            <ProjectModificationsSummaryCard projectId={projectId} />
