                ...
                {filteredLots.map((lot) => (
                  <tr key={lot.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600">
                      ...
                      {lot.floor && <div className="text-xs text-gray-500">{lot.floor.label}</div>}
                    </td>
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600">
                      {lot.roomsLabel || '—'}
                    </td>
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      {lot.buyer ? (
                        <div className="text-sm">
                          ...
                          <div className="text-xs text-gray-500">{lot.buyer.email}</div>
                        </div>
                      ) : (
                        <span className="text-sm text-gray-400">Aucun acheteur</span>
                      )}
                    </td>
                  </tr>
                ))}
          ...
          <div className="border-t border-gray-200 px-4 py-3 bg-gray-50">
            <div className="text-sm text-gray-600">
              ...
              {filterStatus && lots.length !== filteredLots.length && (
                <span className="text-gray-500"> (sur {lots.length})</span>
              )}
            </div>
          </div>
        </Card>
