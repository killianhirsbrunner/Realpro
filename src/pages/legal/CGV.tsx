      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <div className="grid gap-4">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Enterprise</h4>
                  <ul className="list-disc list-inside space-y-1 text-sm ml-2">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Custom</h4>
                  <ul className="list-disc list-inside space-y-1 text-sm ml-2">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">3.3 Périodicité</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">3.4 Évolution des prix</h4>
                <p>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Période d'essai gratuite</h4>
                <p>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">5.1 Prestataire de paiement</h4>
                <p>Tous les paiements sont gérés par :</p>
                <p className="font-semibold text-gray-900 dark:text-white mt-2">Datatrans AG</p>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">5.2 Moyens de paiement acceptés</h4>
                <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">5.4 Renouvellement automatique</h4>
                <p>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">5.5 Échec de paiement</h4>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">8.1 Résiliation par le Client</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">8.2 Procédure de résiliation</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">8.4 Conséquences de la résiliation</h4>
                <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <table className="min-w-full border-collapse border border-gray-200 dark:border-gray-700">
                <thead>
                  <tr className="bg-gray-50 dark:bg-gray-700">
                    <th className="border border-gray-200 dark:border-gray-700 px-4 py-2 text-left text-gray-900 dark:text-white">Formule</th>
                    <th className="border border-gray-200 dark:border-gray-700 px-4 py-2 text-left text-gray-900 dark:text-white">Canal</th>
                    <th className="border border-gray-200 dark:border-gray-700 px-4 py-2 text-left text-gray-900 dark:text-white">Délai de réponse</th>
                    <th className="border border-gray-200 dark:border-gray-700 px-4 py-2 text-left text-gray-900 dark:text-white">Disponibilité</th>
                  </tr>
                </thead>
                <tbody className="text-gray-700 dark:text-gray-300">
                  <tr>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2 font-semibold">Basic</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">Email / Ticket</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">48h ouvrées</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">Jours ouvrés</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2 font-semibold">Professional</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">Email / Ticket / Chat</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">24h ouvrées</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">Jours ouvrés</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2 font-semibold">Enterprise</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">Email / Ticket / Chat / Téléphone</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">4h ouvrées</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">8h-18h + Astreinte</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2 font-semibold">Custom</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">Dédié + SLA personnalisé</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">Selon contrat</td>
                    <td className="border border-gray-200 dark:border-gray-700 px-4 py-2">Selon contrat</td>
                  </tr>
                </tbody>
              </table>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Limitation de responsabilité</h4>
          ...
          <section>
            ...
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              <p>Les présentes CGV sont régies par le <strong className="text-gray-900 dark:text-white">droit suisse</strong>.</p>
