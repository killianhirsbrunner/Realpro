...
async function getSalesContractDetail(supabase: any, contractId: string) {
  const { data: contract, error } = await supabase
    ...
    .select(`
      ...
      lot:lots(id, lot_number, rooms_label, surface_habitable, price_total, price_base, building:buildings(name)),
  ...
  return {
    ...
    lot: contract.lot ? {
      ...
      priceTotal: contract.lot.price_total,
      priceBase: contract.lot.price_base,
